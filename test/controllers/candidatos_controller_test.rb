...
class CandidatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidato" do
    assert_difference('Candidato.count') do
      post candidatos_url, params: { candidato: { nome: @candidato.nome, numero: @candidato.numero } }
    end
  ...
  test "should update candidato" do
    patch candidato_url(@candidato), params: { candidato: { nome: @candidato.nome, numero: @candidato.numero } }
